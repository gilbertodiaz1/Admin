    ...
    <div class="row-fluid">
        <div class="span12">
            <div id="body-div">
                ...
                <div class="wizard">
                    <div class="step1 greenStep2"><img src="images/wizard/1.png" alt=""/>

                        <p><?php echo SELECT_DATES_TEXT; ?></p></div>
                    <div class="step2 greenStep"><img src="images/wizard/2.png" alt=""/>

                        <p><?php echo ROOMS_TEXT; ?> &amp; <?php echo RATES_TEXT; ?></p></div>
                    <div class="step3 yellowStep"><img src="images/wizard/3.png" alt=""/>

                        <p><?php echo YOUR_DETAILS_TEXT; ?></p></div>
                    <div class="step4 grayStep"><img src="images/wizard/4.png" alt=""/>

                        <p><?php echo PAYMENT_TEXT; ?></p></div>
                    <div class="step5 grayLastStep"><img src="images/wizard/5.png" alt=""/>

                        <p><?php echo CONFIRM_TEXT; ?></p></div>
                </div>
                <div class="progress">
                ...
                <div class="wrapper">
                    ...
                    <table cellpadding="4" cellspacing="1" class="table table-bordered table3">
                        ...
                        <tr>
                            <td bgcolor="#faa448" align="center"><strong><?php echo NUMBER_OF_ROOM_TEXT; ?></strong>
                            </td>
                            <td bgcolor="#faa448" align="center"><strong><?php echo ROOM_TYPE_TEXT; ?></strong></td>
                            <td bgcolor="#faa448" align="center"><strong><?php echo MAXI_OCCUPENCY_TEXT; ?></strong>
                            </td>
                            <td bgcolor="#faa448" class="al-r" style="padding-right:5px;">
                                <strong><?php echo GROSS_TOTAL_TEXT; ?></strong></td>
                        </tr>
                        <?php
                        ...
                        <td class="al-r" colspan="3" bgcolor="#faa448"><strong><?php echo SUB_TOTAL_TEXT; ?></strong>
                        </td>
                        <td class="al-r" bgcolor="#faa448" style="padding-right:5px;">
                            <strong> <?php echo $bsiCore->get_currency_symbol($_SESSION['sv_currency']) . $bsiCore->getExchangemoney($bsibooking->roomPrices['subtotal'], $_SESSION['sv_currency']); ?></strong>
                        </td>
                        </tr>
                        <?php
                        if ($bsiCore->config['conf_tax_amount'] > 0 && $bsiCore->config['conf_price_with_tax'] == 0) {
                            ...
                            <tr>
                                ...
                                <td class="al-r" bgcolor="#fcb66c" style="padding-right:5px;"><span
                                        id="taxamountdisplay"><?php echo $bsiCore->get_currency_symbol($_SESSION['sv_currency']) . $bsiCore->getExchangemoney($bsibooking->roomPrices['totaltax'], $_SESSION['sv_currency']); ?></span>
                                </td>
                            </tr>
                        <?php } else {
                            $taxtext = "(" . BD_INC_TAX . ")";
                        ...
                        <tr>
                            <td class="al-r" colspan="3" bgcolor="#faa448">
                                <strong><?php echo GRAND_TOTAL_TEXT; ?></strong> <?php echo $taxtext; ?></td>
                            <td class="al-r" bgcolor="#faa448" style="padding-right:5px;"><strong> <span
                                        id="grandtotaldisplay"><?php echo $bsiCore->get_currency_symbol($_SESSION['sv_currency']) . $bsiCore->getExchangemoney($bsibooking->roomPrices['grandtotal'], $_SESSION['sv_currency']); ?></span></strong>
                            </td>
                        </tr>
                        <?php
                            ...
                            <div class="span12">
                                ...
                                <form class="form-horizontal" action="booking-process.php" method="post" id="form1"
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" name="email_addr_existing" id="email_addr_existing"
                                                   class="input-large"/>
                                        </div>
                                    </div>
                                    <div class="control-group">
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <button id="btn_exisitng_cust" type="button"
                                                    style="display:inline-block"><?php echo FETCH_DETAILS_TEXT; ?></button>
                                            <a href="javascript:;" id="forgot_pass"
                                               style="width:150px; display:inline-block; padding-left:10px; cursor:pointer;">Forgot
                                                Password?</a>
                                        </div>
                                    </div>
                                    ...
                                    <h3 align="left"
                                        style="padding-left:5px; color:#999;"><?php echo NEW_CUSTOMER_TEXT; ?>?</h3>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input name="zipcode" id="zipcode" type="text"
                                                   class="input-large required number">
                                        </div>
                                    </div>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input name="id_type" id="id_type" type="text" class="input-large"><span
                                                class="help-inline">(e.g.: passport.)</span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input name="id_number" id="id_number" type="text"
                                                   class="input-large required"><span class="help-inline">(e.g.: passport number.)</span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="control-group">
                                        <label class="control-label" for="ar"><?php echo ADDITIONAL_REQUESTS_TEXT; ?>
                                            :</label>
                                        ...
                                        <div class="controls">
                                            ...
                                            <label class="checkbox">
                                                ...
                                                <?php echo I_AGREE_WITH_THE_TEXT; ?> <a href="javascript: ;"
                                                                                        onClick="javascript:myPopup2();"> <?php echo TERMS_AND_CONDITIONS_TEXT; ?>
                                                    .</a>
                                            </label>
                            ...
                            <div class="span12">
                                <div class="back1">
                                    <button id="registerButton" type="button"
                                            onClick="window.location.href='booking-search.php'"><?php echo BACK_TEXT; ?></button>
                                </div>
                                <div class="home">
                                    <button id="registerButton" type="button" class='home-btn'
                                            onClick="window.location.href='index.php'"><?php echo HOME_TEXT; ?></button>
                                </div>
                                <div class="continue1">
                                    <button id="registerButton" type="submit"
                                            class="conti"><?php echo CONTINUE_TEXT; ?></button>
                                </div>
                            </div>
                        </div>
                    </div>
