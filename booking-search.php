            ...
            <div class="row-fluid">
                <div class="span12">
                    <div id="body-div">
                        ...
                        <div class="wrapper">
                            <h2>
                                <?php echo SEARCH_INPUT_TEXT; ?> (<a href="index.php"><?php echo MODIFY_SEARCH_TEXT; ?></a>)
                            </h2>
                            ...
                            <form name="searchresult" id="searchresult" method="post" action="booking_details.php" onSubmit="return validateSearchResultForm('<?php echo SELECT_ONE_ROOM_ALERT; ?>');">
                                <div class="wrapper">
                                    <div class="htitel">
                                        <h2 class="fl" style="border:0; margin:0;">
                                            <?php echo SEARCH_RESULT_TEXT; ?>
                                        </h2>
                                                                    ...
                                                                    <table  width="100%" class="table table-bordered table2">
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td bgcolor="#faa448" colspan="2">
                                                                                ...
                                                                                ( <a style="color:#fff; font-size:13px" id='iframe2_<?php echo str_replace(" ","",$room_type['rtid']).'_'.str_replace(" ","",$capid).$ik; ?>' href="calendar.php?rtype=<?php echo $room_type['rtid']; ?>&cid=<?php echo $capid; ?>" title='<span  style="font-size:16px;"><strong><?php echo $room_type['rtname']; ?></strong> ( <?php echo $capvalues['captitle']; ?> ) </span>' >
                                                                                    <strong>
                                    ...
                                    <div class="container-fluid" style="margin:0; padding:0;">
                                        <div class="row-fluid" style="background-color: #faac59; padding: 1% 0">
                                            ...
                                            <div class="span12">
                                                ...
                                                <div class="continue2">
                                                    <button id="registerButton" type="submit" class="conti2" >
